...
getAudioDevices(){
  global audioCount, selected, IMMDevice, IMMDeviceCollection, IMMDeviceEnumerator, Devices2, Devices3
  ...
  For DeviceName, DeviceID in Devices {
      List .= "(" . A_Index . ") " . DeviceName . "`n"
      ObjRawSet(Devices2, A_Index, DeviceID)
      ObjRawSet(Devices3, A_Index, DeviceName)
  }
  ;InputBox n,, % List,,,,,,,, 1
...
toggleAudio(){
  global audioCount, selected, Devices3
  getAudioDevices()
    ...
    selectAudioDevice(selected)
    TrayTip Karta dźwiękowa, % Devices3[selected]
